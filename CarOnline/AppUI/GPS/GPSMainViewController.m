...
- (BMKAnnotationView *)mapView:(BMKMapView *)mapView viewForAnnotation:(id<BMKAnnotation>)aAnnotation
{
    @autoreleasepool {
        ...
        if (vav == nil)
        {
            DebugLog(@"BMKAnnotationView alloc-00-0-0-0-0-0-00--0");
        ...
        VehiclePaopaoView *pv = [[VehiclePaopaoView alloc] init];
        [pv setGPSVehicle:annotation];
        
        __weak VehiclePaopaoView *wpv = pv;
