...
- (void)showStatusBarNotification:(NSString *)message forDuration:(CGFloat)duration {
    if (!self.statusBarNotificationIsShowing) {
        ...
        [self.navigationController.view addSubview:self.statusBarNotificationLabel];
        [self.navigationController.view bringSubviewToFront:self.statusBarNotificationLabel];
