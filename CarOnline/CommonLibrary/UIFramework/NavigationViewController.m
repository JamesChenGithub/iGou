...
- (void)setNavigationBarAppearance
{
    ...
    UIColor *rgColor = RGB(220, 220, 220);
    if ([IOSDeviceConfig sharedConfig].isIOS6)
    {
        if ([self.navigationBar respondsToSelector:@selector(setBackgroundImage:forBarMetrics:)])
        {
            UIImage *colorImg = [UIImage imageWithColor:rgColor size:CGSizeMake(44, 1)];
            [self.navigationBar setBackgroundImage:colorImg forBarMetrics:UIBarMetricsDefault];
        }
    }
    else
    {
        self.navigationBar.barTintColor = rgColor;
    }
    
    
//    [self.navigationBar setTitleTextAttributes:@{
//                                                 UITextAttributeTextColor:RGB(56, 56, 56),
//                                                 UITextAttributeTextShadowColor:rgColor,
